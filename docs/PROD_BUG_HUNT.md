...
Notes:
- 2026-07-04, the owner on iPhone XR against prod v1.0.0 Build 8.
...
Notes:
- 2026-07-04, the owner. Sign-in worked as expected — Welcome → I
...
- 🟡 iOS OAuth system dialog reads "supabase.co wants to sign in"
  ...
  V1.2_LATER.md.
- Observation about paywall: the owner saw paywall on first-launch
...
Notes:
- 2026-07-04, the owner. Apple sign-in worked end-to-end. Email captured
...
Notes:
- 2026-07-04, the owner. Log Out → Welcome → "I already have an
...
Notes:
- 2026-07-04 — bug reproduced by the owner earlier in the session. Prod
...
Notes:
- 2026-07-04, the owner. ✅ Supabase merged into a SINGLE account.
...
Notes:
- 2026-07-04 — implicitly verified in Section 1.2 (the owner deleted
...
answers) not tested yet. the owner suspects lesson progress may not be
...
**2026-07-04 the owner tested prod v1.0.0 Build 8**:
...
- Better: "We couldn't delete your account right now. This is usually
  ...
  it keeps failing, email support@example.com."
...
24. **Lesson progress persistence**: the owner flagged concerns.
