...
13. The gate placement key stays `learn_module_<lessonSlug>` — a Superwall **dashboard** identifier, not a local string. Renaming it in code silently un-gates those lessons (see invariant 2).
