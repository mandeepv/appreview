...
- [ ] Confirm build shows up in App Store Connect → Kinderwell → TestFlight → Internal Testing → **Homies** group (has 3 testers: `owner@example.com`, `kinderwelltry1@gmail.com`, `jacobf1607@gmail.com`)
