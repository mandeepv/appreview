...
const subLessons: SubLesson[] = [
  {
    ...
    number: '1',
    title: 'Introduction',
    description: 'Understanding what helping really means',
    icon: 'book-outline',
    startScreen: 'HelpingProcessEmotionsSec1Screen1',
  },
  {
    id: '2',
    number: '2',
    title: 'The Sleepover: Take Two',
    description: 'Modeling emotionally attuned listening',
    icon: 'heart-outline',
    startScreen: 'HelpingProcessEmotionsSec2Screen1',
  },
];
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.description}>
            Learn what actually helps when someone is upset — and why emotional moments build deeper bonds.
          </Text>
        </View>
        ...
        <View style={styles.progressSection}>
          <View style={styles.progressHeader}>
            ...
            <View style={styles.progressBadge}>
              <Text style={styles.progressText}>{completedSections.length}/2 Complete</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.bottomInfo}>
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Master the art of emotional support and build stronger connections
            </Text>
          </View>
        </View>
      </ScrollView>
