...
const subLessons: SubLesson[] = [
  {
    ...
    description: 'Understanding this important concept',
    icon: 'help-circle-outline',
    startScreen: 'DissociationSec1Screen1',
  },
  {
    id: '2',
    number: '2',
    title: 'How do we not dissociate',
    description: 'Strategies to stay present and connected',
    icon: 'eye-outline',
    startScreen: 'DissociationSec2Screen1',
  },
  {
    id: '3',
    number: '3',
    title: 'More ways to stop dissociation when it starts',
    description: 'Additional techniques for staying grounded',
    icon: 'shield-outline',
    startScreen: 'DissociationSec3Screen1',
  },
  {
    id: '4',
    number: '4',
    title: 'Summary and Homework',
    description: 'Recap and practical application',
    icon: 'book-outline',
    startScreen: 'DissociationSec4Screen1',
  },
];
  ...
  useFocusEffect(
    React.useCallback(() => {
      const loadProgress = async () => {
        const completed = await createProgressStore(STORAGE_KEYS.DISSOCIATION_COMPLETED_SECTIONS).getCompletedSections();
    ...
    <View style={styles.container}>
      ...
      >
        ...
        <View style={styles.titleSection}>
          ...
          <Text style={styles.title}>Dissociation</Text>
        ...
        <View style={styles.progressSection}>
          <View style={styles.progressHeader}>
            ...
            <View style={styles.progressBadge}>
              <Text style={styles.progressText}>{completedSections.length}/4 Complete</Text>
            </View>
          </View>
        </View>
        ...
        <View style={styles.bottomInfo}>
          <View style={styles.infoCard}>
            ...
            <Text style={styles.infoText}>
              Learn to recognize and respond to dissociation in yourself and others
            </Text>
          </View>
        </View>
      </ScrollView>
