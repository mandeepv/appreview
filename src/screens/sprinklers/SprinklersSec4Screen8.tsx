...
type Props = NativeStackScreenProps<LessonStackParamList, 'SprinklersSec4Screen8'>;

export const SprinklersSec4Screen8: React.FC<Props> = ({ navigation }) => {
    ...
    const handleNext = () => {
        navigation.navigate('SprinklersSec4Screen9');
    };
