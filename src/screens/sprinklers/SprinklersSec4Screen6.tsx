...
type Props = NativeStackScreenProps<LessonStackParamList, 'SprinklersSec4Screen6'>;

export const SprinklersSec4Screen6: React.FC<Props> = ({ navigation }) => {
    ...
    const handleNext = () => {
        navigation.navigate('SprinklersSec4Screen7');
    };
