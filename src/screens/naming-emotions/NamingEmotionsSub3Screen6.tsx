...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub3Screen6'>;

export const NamingEmotionsSub3Screen6: React.FC<Props> = ({ navigation }) => {
  const handleContinue = async () => {
    await markSubLessonComplete('3');
