...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub2Screen4'>;

export const NamingEmotionsSub2Screen4: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = () => {
    navigation.navigate('NamingEmotionsSub2Screen5');
  };
