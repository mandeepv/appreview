...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub4Screen4'>;

export const NamingEmotionsSub4Screen4: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = () => {
    navigation.navigate('NamingEmotionsSub4Screen5');
  };
