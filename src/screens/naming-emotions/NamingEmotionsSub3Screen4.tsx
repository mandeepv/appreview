...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub3Screen4'>;

export const NamingEmotionsSub3Screen4: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = () => {
    navigation.navigate('NamingEmotionsSub3Screen5');
  };
