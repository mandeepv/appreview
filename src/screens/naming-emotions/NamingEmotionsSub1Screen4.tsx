...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub1Screen4'>;

export const NamingEmotionsSub1Screen4: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = () => {
    navigation.navigate('NamingEmotionsSub1Screen5');
  };
