...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub1Screen5'>;

export const NamingEmotionsSub1Screen5: React.FC<Props> = ({ navigation }) => {
  ...
  const handleNext = () => {
    navigation.navigate('NamingEmotionsSub1Screen6');
  };
