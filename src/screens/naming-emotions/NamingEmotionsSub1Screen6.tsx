...
type Props = NativeStackScreenProps<LessonStackParamList, 'NamingEmotionsSub1Screen6'>;

export const NamingEmotionsSub1Screen6: React.FC<Props> = ({ navigation }) => {
  const handleContinue = async () => {
    await markSubLessonComplete('1');
