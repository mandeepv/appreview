...
type Props = NativeStackScreenProps<LessonStackParamList, 'SandbagsSec2Screen8'>;

export const SandbagsSec2Screen8: React.FC<Props> = ({ navigation }) => {
    const [selectedOption, setSelectedOption] = useState<number | null>(null);
    const [isCorrect, setIsCorrect] = useState<boolean | null>(null);

    const options = [
        'It’s hard for them to do on their own',
        'It gives us a sense of purpose and accomplishment',
        'It creates feelings that bond us together',
        'All of the above',
    ];
    ...
    const handleNext = () => {
        navigation.navigate('SandbagsSec2Screen9');
    };
        ...
        >
            <View style={styles.container}>
                <View style={styles.content}>
                    ...
                    {isCorrect !== null && (
                        <View style={[styles.feedbackBox, styles.correctFeedback]}>
