...
type Props = NativeStackScreenProps<LessonStackParamList, 'Lesson4Complete'>;

export const Lesson4Complete: React.FC<Props> = ({ navigation }) => {
    ...
    >
      <View style={styles.content}>
        ...
        <Animated.View style={{ opacity: fadeAnim }}>
          <Text style={styles.headline}>Foundation Complete</Text>
          <Text style={styles.subheadline}>
            You now understand the chemistry of well-being
          </Text>

          <View style={styles.learningCard}>
            <Text style={styles.learningTitle}>What You've Learned:</Text>
            <View style={styles.bulletList}>
              <Text style={styles.bullet}>• What not to chase (dopamine)</Text>
              <Text style={styles.bullet}>• What to reduce (cortisol)</Text>
              <Text style={styles.bullet}>• What to build (oxytocin)</Text>
            </View>
          </View>
