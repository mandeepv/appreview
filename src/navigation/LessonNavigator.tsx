...
import type { LessonStackParamList } from './types';

// DEPRECATED transitional shim (SPEC-08). The LessonStackParamList now lives
// in navigation/types.ts (the single composition home) — import it from there
// in new code. This re-export only keeps existing importers compiling; it dies
